...
export type FilterStringKeys<T> = keyof ExtractPropertiesByType<
	T,
	string | (string | undefined)
>;

export type FilterBooleanKeys<T> = keyof ExtractPropertiesByType<
	T,
	boolean | (boolean | undefined)
>;

export type FilterNumberKeys<T> = keyof ExtractPropertiesByType<
	T,
...
export const SettingInformation: Partial<
	Record<keyof AllSettings, ConfigurationItem>
> = {
	liveSync: {
		name: "Sync Mode",
	},
