...
export type SYNC_MODE =
	| typeof MODE_SELECTIVE
	| typeof MODE_AUTOMATIC
	| typeof MODE_PAUSED
	| typeof MODE_SHINY;
...
interface PluginSyncSettings {
	 ...
	 */
	pluginSyncExtendedSetting: Record<
		PluginSyncSettingEntry["key"],
...
export type E2EEAlgorithm =
	| (typeof E2EEAlgorithms)[keyof typeof E2EEAlgorithms]
	| "";
...
export type ChunkSplitterVersion =
	| (typeof ChunkAlgorithms)[keyof typeof ChunkAlgorithms]
	| "";
...
export type ObsidianLiveSyncSettings = ObsidianLiveSyncSettings_PluginSetting &
	RemoteDBSettings &
	LocalDBSettings;
