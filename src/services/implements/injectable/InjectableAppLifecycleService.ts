...
export abstract class AppLifecycleServiceBase<
	T extends ServiceContext,
> extends AppLifecycleService<T> {
	...
	isReloadingScheduled = handlers<IAppLifecycleService>().binder(
		"isReloadingScheduled",
	);
}

export abstract class InjectableAppLifecycleService<
