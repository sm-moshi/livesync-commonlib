	...
	implements IConflictService
{
	 ...
	 */
	readonly getOptionalConflictCheckMethod =
		handlers<IConflictService>().firstResult("getOptionalConflictCheckMethod");
	/**
	 ...
	 */
	readonly resolveByUserInteraction = handlers<IConflictService>().firstResult(
